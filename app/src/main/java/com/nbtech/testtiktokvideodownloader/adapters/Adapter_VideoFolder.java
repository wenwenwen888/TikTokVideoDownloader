package com.nbtech.testtiktokvideodownloader.adapters;

import static com.nbtech.testtiktokvideodownloader.utils.Constants.DEL_CONFIRM;
...
import com.nbtech.testtiktokvideodownloader.models.Model_Video;
import com.nbtech.testtiktokvideodownloader.utils.ClipboardUtils;
...
public class Adapter_VideoFolder extends RecyclerView.Adapter<Adapter_VideoFolder.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView tvDuration,tvTitle;
        ...
        void update(final Model_Video video, final int id) {
            ...
            tvTitle.setText(video.getStr_title());
            rl_select.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (multiSelect) {
                        ...
                        final String[] options = {"Watch", "Copy", "Delete", "Share"};
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                } else if (options[which].contains("Copy")) {
                                    ClipboardUtils.INSTANCE.copy(context,video.getStr_title());
